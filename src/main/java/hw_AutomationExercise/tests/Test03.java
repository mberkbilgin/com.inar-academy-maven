...
public class Test03 extends BaseTest {
    ...
    public void login() {
        ...
        pages.getLoginPage().setLoginEmailAddress("asdas@sparrow.com");
        pages.getLoginPage().setLoginEmailPassword("123456");
        pages.getLoginPage().clickLoginButton();

        softAssert.assertEquals(pages.getLoginPage().getIncorrectEmailOrPassword(), "Your email or password is incorrect!");
